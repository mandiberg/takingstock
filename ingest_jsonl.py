...
if THIS_SITE == 1:
    ...
    JSONL_IN_PATH = os.path.join(INGEST_FOLDER, "items_cache.jsonl")
    eth_dict_per_site = {'asian ethnicity':9, 'tika':9, 'alta':9}
elif THIS_SITE == 14:
...
gender_dict_TNB = {"nonbinary":5, "non-binary":5, "non binary":5, "trans ":7, "transman":7, "transmen":7, "transwoman":7, "transwomen":7,"trans man":7, "trans men":7, "trans woman":7, "kathoey":7, "trans women":7, "trans*":7, "transgender":7, "transsexual":7, "transsexuals":7, "genderfluid":5,  "gender fluid":5, "genderqueer":5, "gender queer":5,"gender nonconforming":5, "intersex":12, "androgynous":13, "androgyn":13, "hijra - gender":5, "hijra":5, "bigender":5, "gender non-conforming":5, "agender":5, "transgender woman":7, "transgender women":7,"transgender man":7, "transgender men":7}
...
multi_dict = {"mixedraceperson":6, "mixedrace":6, "mixed-race":6, "mixed race":6, "mixed ethnicity":6, "multiethnic":6, "multi ethnic":6, "multi-ethnic":6, "biracial":6, "afro-latinx":6, "afro-latina":6, "afro-latino":6, "afro-latin":6, "afro-latine":6, "multiracial person":6, "multiracial group":6, "multi-racial":6, "multi racial":6, "eurasian":6, "hapa":6, "hapa person":6}
...
eth_dict_secondary = lower_dict({**eth_dict_istock_secondary, **eth_dict_shutter_secondary, **eth_dict_per_site})
key2key = lower_dict({**key2key, **key2key_getty})
eth_all_dict = lower_dict({**eth_dict, **eth_dict_secondary})
...
all_dict = lower_dict({**eth_all_dict, **gender_all_dict, **key2loc})            
    ...
    try:
        ...
        try:
            ...
            if pd.isnull(key_no):
                ...
                if key and not key.startswith('-') and not key.endswith('.jpg') and not key in all_dict.keys() and not key in (TNB_list+multi_eth_list):
                    # print(type(site_id))
                    # print(site_id)
