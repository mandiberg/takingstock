...
def draw_landmarks_on_image(rgb_image, detection_result):
    ...
    for idx in range(len(hand_landmarks_list)):
        ...
        solutions.drawing_utils.draw_landmarks(
            annotated_image, #No conversion Here, it is already BGR
...
#Convert to BGR before passing to draw_landmarks_on_image
...
output_path = f"{base_name}_hands_lms{extension}"
cv2.imwrite(output_path, annotated_image)

# cv2.imshow("marked image",annotated_image)
