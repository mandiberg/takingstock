...
DEST = "/Users/michaelmandiberg/Library/CloudStorage/Dropbox/takingstock_dropbox/segment_images"
START = 0

# make folders
if USE_DF_SORTED:
    print("Using df_sorted format")
    for path in io.folder_list:
...
def move_files_from_csv(csv_file, start=0):
    ...
    with open(csv_file, mode='r', newline='') as file:
        ...
        for row in reader:
            ...
            last_folder = os.path.dirname(site_root)
