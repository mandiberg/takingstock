...
gender_dict_TNB = {"nonbinary":5, "non-binary":5, "non binary":5, "trans ":7, "transman":7, "transwoman":7, "trans*":7, "transgender":7, "transsexual":7, "genderfluid":5,  "gender fluid":5, "genderqueer":5, "gender queer":5,"gender nonconforming":5, "intersex":12, "androgynous":13}
...
def get_gender_age_row(gender_string, age_string, description, keys_list, site_id):
    ...
    def get_TNB(description):
        ...
        is_code = False
        gender_TNB = None
        TNB_list = ["nonbinary", "non-binary", "non binary", "androgynous", "transgender", "transsexual", "genderfluid",  "gender fluid", "genderqueer", "gender queer","gender nonconforming", "intersex"]
        binary = "binary"
    ...
    gender_TNB = get_TNB(description.lower())    
...
def ingest_csv():
    ...
    #     split_keys = []
    #     for key in keys_list:
    #         if key in pond5_spacedeth:
    #             # adding split and original key
    #             split_keys.extend(key.split(" "))
    #             split_keys.extend(key)   
    #         elif key in pond5_spacedkeys_set:
    #             split_keys.extend(key.split(" "))
    #     final_keys = keys_list + split_keys
