...
CSV_KEY2LOC_PATH = os.path.join(INGEST_FOLDER, "CSV_KEY2LOC.csv")
CSV_KEY2KEY_GETTY_PATH = os.path.join(INGEST_FOLDER, "CSV_KEY2KEY_GETTY.csv")
...
key2key = {"person":"people", "isolated on white":"plain white background", "kid":"child","affection":"affectionate", "baby":"baby - human age", "beautiful":"beautiful people", "pretty":"beautiful people", "blur":"blurred motion", "casual":"casual clothing", "children":"child", "kids":"child", "couple":"couple - relationship", "adorable":"cute", "room":"domestic room", "focus":"focus - concept", "happy":"happiness", "at home":"home interior", "home":"home interior", "face":"human face", "hands":"human hand", "landscape":"landscape - scenery", "outfit":"landscape - scenery", "leisure":"leisure activity", "love":"love - emotion", "guy":"men", "motherhood":"mother", "parenthood":"parent", "positive":"positive emotion", "recreation":"recreational pursuit", "little":"small", "studio shoot":"studio shot", "together":"togetherness", "vertical shot":"vertical", "lady":"women", "young":"young adult", "light":"light - natural phenomenon", "trees":"tree", "disabled":"disability", "landline":"phone", "tradesman":"worker", "apprentice":"work", "arbeit":"work", "wheel-chair":"wheelchair", "treatments":"treatment", "transports":"transportation", "thoughtfully":"thoughtful", "technologies":"technology", "piscine":"swim", "astonished":"surprise", "surgeons":"surgeon", "sommer":"summer", "suffering":"suffer", "studentin":"student", "stressful":"stressed", "smoothies":"smoothie", "smilling":"smiling", "kleines":"small", "sleeps":"sleeping", "dealership":"sales", "salads":"salad", "ressources":"resources", "relaxes":"relaxed", "presentations":"presentation", "phones":"phone", "telefon":"phone", "telefoniert":"phone", "patients":"patient", "papier":"paper", "painful":"pain", "offended":"offend", "occupations":"occupation", "muscled":"muscles", "motivated":"motivation", "pinup":"model", "pin-up":"model", "meetings":"meeting", "massages":"massage", "kleiner":"little", "(lawyer)":"lawyer", "kitchens":"kitchen", "injections":"injection", "hospitals":"hospital", "zuhause":"home", "happily":"happy", "joyfully":"happy", "overjoyed":"happiness", "rejoices":"happiness", "handshaking":"handshake", "groups":"group", "full-length":"full length", "blumen":"flowers", "florists":"florist", "panic":"fear", "fell":"fall", "equipements":"equipement", "enthusiastic":"enthusiasm", "osteopathy":"doctor", "disgusted":"disgust", "schreibtisch":"desk", "dances":"dancing", "crowds":"crowd", "robber":"criminal", "copyspace":"copy space", "misunderstandings":"confusion", "confidently":"confidence", "concerts":"concert", "climbs":"climb", "celebrations":"celebration", "caught":"catch", "casually":"casual", "motorsports":"car", "banker":"business person", "supervisor":"boss", "executives":"boss", "bedrooms":"bedroom", "beautifull":"beautiful", "beaches":"beach", "bathrooms":"bathroom", "backgroud":"background", "attraktive":"attractive", "sportwear":"athletic", "sportliche":"athletic", "addicted":"addiction", "alcoholism":"addiction", "enjoy":"enjoyment", "cleaning supplies": "cleaning products", "cnc machining": "cnc machine", "desktop computer": "desktop pc", "downs syndrome": "down syndrome", "film noir": "film noir style", "flu shot": "flu vaccine", "fly fishing": "fly-fishing", "back pain": "lower back pain", "nyc ny": "new york city", "surgery room": "operating room", "paris france": "paris - france", "cosmetic surgery": "plastic surgery", "portland oregon": "portland - oregon", "belly fat": "pot belly - human body", "tv remote": "remote control", "security officer": "security guard", "semi truck": "semi-truck", "super hero": "superhero", "tablet pc": "tablet computer", "teeth whitening": "tooth whitening", "varicose veins": "varicose vein", "venice italy": "venice - italy", "victoria falls": "victoria falls national park", "wheel chair": "wheelchair", "white male": "white people", "abused woman": "women abuse", "1960s": "1960-1969", "advisor": "advisor", "americana": "american", "antibiotics": "antibiotic", "arabic": "arabic", "asian": "asian", "inhaler": "asthma inhaler", "asthma": "asthmatic", "boomer": "baby boomer", "backdrops": "backdrop", "fired": "being fired", "bullets": "bullet", "camo": "camouflage", "daycare": "childcare", "hvac": "chiller - hvac equipment", "chinese": "chinese", "cigars": "cigar", "cd": "compact disc", "malware": "computer virus", "convict": "criminal", "datacenter": "data center", "deli": "delicatessen", "satan": "devil", "handicapped": "disable", "foyer": "entrance", "fail": "failure", "fees": "fee", "roulette": "gambling", "haunted": "ghost", "cardiac": "heart", "hispanic": "hispanic", "hobo": "homeless", "jobs": "job", "latino": "latino", "litigation": "law", "liar": "lie", "lightening": "lightning", "locksmith": "lock", "lockers": "locker", "loser": "loss", "lungs": "lung", "butler": "maid", "midwest": "midwest", "error": "mistake", "oops": "mistake", "assassin": "murder", "burma": "myanmar", "obstacles": "obstacle", "cubicle": "office cubicle", "olympics": "olympic", "forms": "paperwork", "sinus": "paranasal sinus", "facelift": "plastic surgery", "swat": "police", "broke": "poor", "confidential": "private", "shh": "quiet", "shhh": "quiet", "refugees": "refugee", "roofing": "roof", "genetics": "science", "easy": "simple", "slave": "slavery", "hearing": "sound", "espionage": "spy", "sweating": "sweat", "telecommunications": "telecommunication", "robbery": "theft", "toolbelt": "tools", "trends": "trend", "walker": "walking", "wifi": "wireless technology", "1940s": "1940-1949", "apocalyptic": "apocalypse", "applause": "applauding", "approved": "approve", "barbells": "barbell", "beakers": "beaker", "carbohydrates": "carbohydrate - food type", "consciousness": "conscious", "consumers": "consumerism", "crutches": "crutch", "demons": "demon - fictional character", "diapers": "diaper", "greedy": "greed", "immigration": "immigrant", "messenger": "messaging", "plumbing": "plumber", "podiatry": "podiatrist", "preteens": "preteen", "publishing": "publisher", "regulations": "regulation", "results": "result", "seo": "search engine", "seatbelt": "seat belt", "sorry": "sorrow", "swearing": "swear word", "terrorist": "terrorism", "tiredness": "tired", "toolkit": "toolbox", "ugly": "ugliness", "veterinary": "veterinarian", "shame": "shame - negative emotion", "sunbather": "sunbathing", "alzheimer": "alzheimer's disease", "deaf": "deafness", "rehab": "rehabilitation", "tango": "tango - dance", "vegas": "las vegas", "sprinter": "sprinting", "hired": "hiring", "wipes": "wiping", "stealing": "stealing - crime", "maya": "mayan", "compare": "comparison", "telecom": "telecommunication", "digestion": "digestive system", "mime": "mime artist", "pruning": "pruning - gardening", "printer": "printer - occupation", "thug": "bullying", "virginia": "virginia - us state", "hula": "hula dancer", "biohazard": "biohazard symbol", "nuclear": "nuclear bomb", "hypertension": "hypertensive", "rio": "rio de janeiro", "shoppers": "shopping", "mri": "mri scan", "trampoline": "trampoline - equipment", "phoenix": "phoenix - arizona", "eiffel": "eiffel tower", "cnc": "cnc machine", "superman": "superman - superhero", "sunburn": "sunburned", "provence": "provence-alpes-cote d'azur", "yorkshire": "yorkshire - england", "liver": "liver - offal", "limo": "limousine", "irrigation": "irrigation equipment", "gluten": "gluten free", "softball": "softball - sport", "helpdesk":"IT Support"}
pond5_spacedkeys = ['car mechanic', 'car salesman', 'us flag', 'usa flag', 'flowers isolated', 'restaurant kitchen', 'underwear model', 'car isolated', 'open kitchen', 'pine forest', 'women models', 'green energy', 'ballot box', 'cape cod', 'sad baby', 'training class', 'bathroom interior', 'gold jewelry', 'football coach', 'music notes', 'hurt child', 'house front', 'old wallpaper', 'sad teen', 'people standing', 'depressed people', 'sad people', 'neck pain', 'holding ipad', 'plastic recycling', 'baby sleeping', 'law books', 'retro woman', 'expensive house', 'young person', 'concert stage', 'silver jewelry', 'yoga beach', 'home renovation', 'retired people', 'fat man', 'baby crawling', 'lion roaring', 'global network', 'horse farm', 'business team', 'examination room', 'passport photo', 'happy shopper', 'kids sports', 'manicure girl', 'camera viewfinder', 'kitchen faucet', 'notre dame', 'cooling towers', 'home building', 'thoughtful man', 'snowman outdoors', 'women patient', 'snow landscape', 'washing feet', 'futuristic building', 'manufacturing plant', 'stomach pain', 'blue smoke', 'dog grooming', 'old widow', 'unhappy overweight', 'business negotiation', 'business phone', 'grass mountain', 'fat people', 'helping hand', 'gay marriage', 'wedding black', 'anniversary party', 'futuristic city', 'office room', 'new guinea', 'electric stove', 'smile asian', 'flying saucer', 'pull ups', 'lake louise', 'college football', 'old clock', 'car radio', 'baking utensils', 'woman doctor', 'beautiful model', 'friends eating', 'jump beach', 'car keys', 'turning page', 'chemistry lab', 'sniper rifle', 'green smoothie', 'smiling baby', 'black couple', 'colored balls', 'football helmet', 'college classroom', 'girl selfie', 'laptop outdoors', 'successful people', 'roulette table', 'motorcycle gear', 'kids swimming', 'older man', 'mount everest', 'santa sitting', 'top secret', 'stir fry', 'telephone operator', 'sad woman', 'desert sunset', 'unconditional love', 'estate planning', 'public toilet', 'fashion hair', 'attractive man', 'rock band', 'dentist tools', 'bank building', 'black boy', 'workplace diversity', 'sports arena', 'sports injury', 'moving truck', 'funny business', 'rocket launch', 'businessman phone', 'protein powder', 'mobile devices', 'business development', 'ear infection', 'suburban street', 'sad couple', 'hands picking', 'bikini girl', 'audio book', 'teenager portrait', 'website traffic', 'man in suit', 'car woman', 'office door', 'movie theatre', 'chewing gum', 'hotel manager', 'crazy woman', 'driving school', 'baby picture', 'interest rates', 'business assistant', 'beer glasses', 'office lobby', 'adult education', 'interior wall', 'pregnant mother', 'pool deck', 'dog running', 'house building', 'radio microphone', 'metal door', 'fitness men', 'smiling child', 'business communications', 'head injury', 'holding iphone', 'tablet family', 'aggressive driving', 'santa barbara', 'funny man', 'christmas candle', 'baseball game', 'beer pub', 'animal baby', 'night forest', 'fruit basket', 'stop smoking', 'suburban neighborhood', 'family playing', 'drug store', 'city bus', 'stage curtains', 'woman screaming', 'table set', 'sleeping man', 'roof repair', 'woman standing', 'halloween party', 'late summer', 'woman teacher', 'marathon runner', 'crying baby', 'scales of justice', 'pig farm', 'soccer stadium', 'healthcare medical', 'party mask', 'selfie photo', 'old hands', 'old wall', 'sad clown', 'restaurant table', 'quit smoking', 'woman smiling', 'luxury villas', 'broken toy', 'hammock beach', 'dietary supplements', 'black student', 'sad teenager', 'family photo', 'pet store', 'kids jumping', 'woman driving', 'health information', 'profile pictures', 'poor children', 'online survey', 'futuristic room', 'hand pointing', 'old radio', 'wine barrels', 'home library', 'straight road', 'lcd tv', 'american soldier', 'news reporter', 'confident woman', 'male teacher', 'giant panda', 'long road', 'man shaving', 'laser hair', 'dog snow', 'sad lonely', 'business building', 'tax time', 'pool cleaning', 'background texture', 'woman forest', 'young student', 'plants growing', 'cat snow', 'depressed man', 'country western', 'production studio', 'family fun', 'science lab', 'white van', 'rainy sky', 'professional kitchen', 'doctor on phone', 'young professional', 'sad puppy', 'boring party', 'healthy man', 'office cleaning', 'senior male', 'crazy people', 'animal rescue', 'oil rig', 'female face', 'worried bills', 'fitness training', 'sky clouds', 'background pattern', 'houston texas', 'butcher block', 'winter house', 'black bear', 'pyramids giza', 'funny selfie', 'future city', 'crosswalk sign', 'doll house', 'writing check', 'Business Person', 'watching football', 'beauty treatments', 'business deal', 'people shopping', 'stomach ache', 'teen computer', 'angry woman', 'happy customer', 'laughing toddler', 'human organ', 'business hotel', 'tired woman', 'baby tiger', 'red peppers', 'technology background', 'wood floor', 'cheating man', 'computer security', 'tv studio', 'funny dog', 'medical technology', 'restaurant bar', 'puerto vallarta', 'murder scene', 'large group', 'snow falling', 'old tv', 'oil barrel', 'elderly care', 'strategic planning', 'corn farm', 'spring forest', 'diamond necklace', 'bad credit', 'young business', 'happy dentist', 'middle school', 'using ipad', 'mona lisa', 'building engineer', 'movie production', 'native american', 'flash drive', 'kids running', 'car wreck', 'lab technician', 'girl friends', 'man silhouette', 'medical science', 'pirate ship', 'medical office', 'future fashion', 'flamenco dancer', 'grizzly bear', 'christmas food', 'rich people', 'basketball girl', 'autumn path', 'eye doctor', 'great wall', 'disabled adult', 'male fashion', 'business seminar', 'judge gavel', 'teen depression', 'male patient', 'smart home', 'face transparent', 'family house', 'models eyes', 'cyber crime', 'happy children', 'helping people', 'gift card', 'boxer dog', 'modern bathroom', 'teenager headache', 'office window', 'men outside', 'temple door', 'computer class', 'insurance policy', 'dirty hands', 'man praying', 'woman reading', 'snow tree', 'empty hall', 'poppy field', 'elevator doors', 'hospital room', 'fat guy', 'funny couple', 'clothes closet', 'forest road', 'international business', 'phoenix arizona', 'reading bible', 'woman praying', 'wounded soldier', 'luxury bathroom', 'ripped paper', 'family portrait', 'happy dog', 'muscle man', 'baby book', 'storm clouds', 'healthy hair', 'unhappy person', 'kids soccer', 'business growth', 'hair cut', 'blank signs', 'christmas room', 'unhappy couples', 'food packaging', 'software developer', 'assembly line', 'kids room', 'free shipping', 'dinosaur skeleton', 'laughing baby', 'sports action', 'woman beach', 'successful businessman', 'truck cargo', 'happy kids', 'mature businessman', 'white room', 'overweight woman', 'child praying', 'asian boy', 'female boxers', 'outdoor party', 'route 66', 'palm sunday', 'empty loft', 'internet marketing', 'coffee business', 'college graduate', 'prescription pad', 'red tape', 'lima peru', 'house keys', 'open bible', 'despair woman', 'dog bath', 'cowboy boots', 'dark alley', 'tropical forest', 'hospital building', 'sick patient', 'wood sign', 'children laughing', 'baby room', 'pet love', 'fortune cookie', 'airport security', 'money cash', 'african business', 'funny woman', 'one dollar', 'man running', 'special offer', 'office unhappy', 'empty pockets', 'african child', 'business tablet', 'paris cafe', 'internet connection', 'smiling face', 'beautiful house', 'asian toddler', 'desert landscape', 'house sold', 'lesbian couple', 'florence italy', 'surprised woman', 'girl smoking', 'happy business', 'old telephone', 'children hospital', 'world cup', 'pool water', 'green blur', 'old paper', 'music lessons', 'police man', 'girl cheeky', 'fat woman', 'bloody knife', 'soccer goalie', 'business asian', 'house windows', 'construction crane', 'digital video', 'crazy man', 'video editing', 'man face', 'hooded man', 'red bow', 'old phone', 'grocery shopping', 'floor cleaning', 'bamboo forest', 'house construction', 'human trafficking', 'cloud software', 'welcome home', 'hospital emergency', 'police arrest', 'summer sun', 'businessman smiling', 'rock concert', 'silicon valley', 'movie set', 'lake tahoe', 'key hole', 'rome skyline', 'stadium lights', 'abandoned warehouse', 'african family', 'woman gym', 'australian flag', 'women talking', 'open house', 'medical team', 'kitchen coffee', 'dog christmas', 'girl face', 'package delivery', 'painter professional', 'road bicycle', 'green juice', 'old factory', 'public relations', 'new construction', 'giving hands', 'dog training', 'baby hands', 'bavarian girl', 'strong man', 'stylish room', 'hot sun', 'dark forest', 'party lights', 'happy laptop', 'smartphone search', 'computer consulting', 'child birthday', 'male face', 'chicken farm', 'watching sport', 'radio studio', 'window cleaning', 'business presentation', 'man tablet', 'neck injury', 'heart health', 'macro flower', 'university classroom', 'business headshot', 'people arguing', 'halloween decorations', 'beautiful skin', 'home for sale', 'la jolla', 'business branding', 'angry kid', 'vintage telephone', 'friends hugging', 'african village', 'abstract blue', 'hands sky', 'warehouse interior', 'notebook paper', 'troubled teen', 'lazy man', 'cracked glass', 'paint splatter', 'foot pain', 'dirty water', 'guitar player', 'obese woman', 'dancing ocean', 'retail store', 'sun beach', 'architectural drawings', 'running outside', 'black girl', 'red smoke', 'fitness class', 'dirty dishes', 'dog teeth', 'water well', 'couple love', 'vintage room', 'female pilot', 'summer park', 'cosmetic beauty', 'mouth tape', 'seattle washington', 'internet security', 'vintage radio', 'night room', 'paint cans', 'green business', 'scared woman', 'muscular man', 'vintage tv', 'club party', 'chinese smile', 'work stress', 'cusco peru', 'loud noise', 'container ships', 'smiling kids', 'shirtless man', 'fitness club', 'chicken wings', 'old train', 'new baby', 'chinese doctor', 'cctv camera', 'farm family', 'dark wood', 'friendly face', 'washington monument', 'doctor patient', 'business technology', 'family room', 'senior sick', 'woman mirror', 'ancient egypt', 'empty bed', 'computer server', 'coming soon', 'cake candles', 'mother baby', 'new car', 'american portrait', 'vintage map', 'suburban home', 'holiday shopping', 'angry driver', 'bored students', 'dog tags', 'car crash', 'blood transfusion', 'eyes makeup', 'family travel', 'baby toys', 'christmas packages', 'spa resort', 'money falling', 'modern dance', 'data analysis', 'party people', 'hospital hallway', 'factory workers', 'money tree', 'car tire', 'neighborhood street', 'woman shopping', 'woman in bikini', 'medical records', 'hands love', 'person computer', 'muslim prayer', 'old dog', 'sound wave', 'homeless child', 'wrist pain', 'black baby', 'sleeping woman', 'digital future', 'money stack', 'candy corn', 'disabled senior', 'punk woman', 'lake sunset', 'wrinkled skin', 'dollar bill', 'dairy products', 'japan traditional', 'delivery truck', 'sad kid', 'server farm', 'video editor', 'yoga poses', 'closeup portrait', 'business laptop', 'contact center', 'evil man', 'retirement home', 'teen girl', 'home care', 'healthy snack', 'people collage', 'sonoma valley', 'lonely teen', 'confused man', 'dirty clothes', 'mexico flag', 'children beach', 'modern home', 'yankee stadium', 'scared girl', 'online training', 'happy baby', 'job loss', 'woman eating', 'task list', 'man diet', 'children running', 'older people', 'dead body', 'patient smiling', 'man on computer', 'asian sad', 'asian athlete', 'dog shelter', 'winning attitude', 'wheat grain', 'white dove', 'old castle', 'manager face', 'monument valley', 'business executive', 'health insurance', 'empty warehouse', 'man smiling', 'buckingham palace', 'friends talking', 'theater stage', 'drinking beer', 'stormy sky', 'spinal cord', 'tile floor', 'sad portrait', 'modern kitchen', 'store owner', 'empty classroom', 'sick dog', 'student portrait', 'woman laptop', 'golf green', 'drug addict', 'computer business', 'plank exercise', 'children books', 'isolated teen', 'hair styling', 'old boat', 'room wall', 'basketball game', 'body waxing', 'asian baby', 'teacher classroom', 'portrait model', 'tropical island', 'people gardening', 'knee pain', 'garage sale', 'creative people', 'blind person', 'business handshake', 'small dog', 'sunrise mountain', 'african boy', 'fishing stream', 'road closed', 'retro phone', 'scary woman', 'tree planting', 'problem solving', 'horror ghost', 'blow kisses', 'company logo', 'leg pain', 'angry wife', 'men fashion', 'business marketing', 'guitar amp', 'popcorn isolated', 'sold home', 'mowing lawn', 'veiled chameleon', 'lonely girl', 'hispanic family', 'airport gate', 'checkered flag', 'frustrated man', 'happy car', 'school hallway', 'marketing ideas', 'running stairs', 'small house', 'sad dog', 'smiley face', 'medical students', 'lake fishing', 'new job', 'technology innovation', 'happy man', 'geiger counter', 'golf hole', 'web site', 'mail box', 'denver colorado', 'sad senior', 'doctors office', 'elderly sad', 'coloured pencils', 'computer learning', 'eye cream', 'restaurant interior', 'women smart phones', 'kid gift', 'decision making', 'birds eating', 'man portrait', 'club lights', 'water tank', 'business training', 'baby play', 'alarm system', 'aching back', 'christmas snow', 'hispanic toddler', 'london night', 'california beach', 'hotel lobby', 'dog hug', 'school backpacks', 'cityscape night', 'garden fence', 'boy face', 'love triangle', 'man shopping', 'family vacation', 'exam room', 'tv room', 'female headshot', 'silhouette head', 'female legs', 'boy cooking', 'diet food', 'london bus', 'baseball pitcher', 'coffee espresso', 'couple talking', 'working online', 'doctor and child', 'white wedding', 'business stress', 'students computer', 'dark street', 'office background', 'film production', 'christmas banner', 'catholic mass', 'gold bracelet', 'lose weight', 'elevator panel', 'laughing laptop', 'cat portrait', 'money problems', 'girl crying', 'starting blocks', 'mobile tablet', 'space stars', 'flowers blooming', 'vintage microphone', 'torn paper', 'toddler girl', 'college campus', 'senior doctor', 'dentist office', 'relax time', 'ski jump', 'office asian', 'empty room', 'white kitchen', 'computer desk', 'christmas shopping', 'squat exercise', 'sales person', 'brain scan', 'fit body', 'home remodeling', 'mysterious woman', 'prescription drugs', 'children reading', 'laptop isolated', 'ipad business', 'fried fish', 'outdoor sports', 'assault rifle', 'snow storm', 'baseball dugout', 'office phone', 'portrait overweight', 'client meeting', 'broken window', 'homeless shelters', 'luxury kitchen', 'snow forest', 'female smiling', 'empty office', 'future technology', 'food plate', 'man thinking', 'lady bug', 'e cig', 'family smiling', 'old bicycle', 'mens shoes', 'anxiety woman', 'office staff', 'kid pointing', 'holy communion', 'men talking', 'tattoo girl', 'girl snow', 'movie studio', 'single man', 'nuclear power', 'skin disease', 'science fiction', 'wearing glasses', 'women working', 'stressed woman', 'dead girl', 'shooting star', 'video interview', 'house fire', 'hospital patient', 'solar farm', 'doctor computer', 'server rack', 'angry boss', 'fitness african', 'personal training', 'breaking news', 'retail shopping', 'angry child', 'woman thinking', 'baby jesus', 'beautiful hair', 'power tools', 'old typewriter', 'children eating', 'medical instruments', 'family beach', 'auto insurance', 'child business', 'elderly smile', 'construction building', 'business office', 'milan italy', 'baby crib', 'female singer', 'business celebration', 'homeless man', 'headshot man', 'data security', 'depressed woman', 'artist painting', 'metal sheet', 'stop watch', 'candid portrait', 'radio black', 'crying woman', 'tropical beach', 'summer beach', 'suburban house', 'child alone', 'dog paw', 'hispanic business', 'birmingham alabama', 'successful man', 'jail cell', 'mountain sunset', 'thai massage', 'pressure washing', 'school students', 'home health care', 'football game', 'steak dinner', 'winter lake', 'dogs playing', 'sick people', 'college building', 'corporate office', 'people at work', 'smile business', 'make money', 'sad child', 'work injury', 'cute toddler', 'san antonio', 'father daughter', 'dna helix', 'clean water', 'angry teacher', 'bikini model', 'skyline night', 'laundry room', 'gift tag', 'iced tea', 'school teacher', 'female portraits', 'court room', 'business charts', 'selfie stick', 'water heater', 'soccer girl', 'soccer fans', 'messy bed', 'business group', 'puzzle pieces', 'job application', 'older woman', 'restaurant menu', 'computer code', 'columbus ohio', 'scared face', 'business interview', 'country music', 'joint pain', 'couple smiling', 'elder care', 'concrete room', 'woman gun', 'aging skin', 'girl computer', 'kids reading', 'cute rabbit', 'grunge wall', 'reading tablet', 'sold sign', 'men portraits', 'angry person', 'sunset field', 'tiger cub', 'car lot', 'couples feet', 'young brunette', 'home security', 'puppy playing', 'dental office', 'female teacher', 'happy employees', 'content marketing', 'caution tape', 'computer industry', 'barrier reef', 'swimsuit model', 'website design', 'computer repair', 'angry man', 'business credit', 'eating sandwich', 'physical rehabilitation', 'movie screen', 'shop owner', 'happy seniors', 'creative team', 'business success', 'carpet cleaning', 'seniors exercising', 'home construction', 'pearl harbor', 'business hand', 'demon man', 'young corporate', 'snowy christmas', 'tokyo city', 'heart monitor', 'paying bills', 'overweight man', 'dog costume', 'kids hands', 'iphone 6', 'apartment interior', 'aquarium fish', 'woman sword', 'house inspection', 'child girl', 'mission goals', 'excited woman', 'save money', 'mixing board', 'sick child', 'garage door', 'wood fence', 'carnival ride', 'hispanic couple', 'overweight sad', 'apartment complex', 'trail running', 'witch broom'] 
...
gender_dict_TNB = {"nonbinary":5, "non-binary":5, "non binary":5, "trans ":7, "transman":7, "transwoman":7, "trans*":7, "transgender":7, "transsexual":7, "genderfluid":5,  "gender fluid":5, "genderqueer":5, "gender queer":5,"gender nonconforming":5, "intersex":12, "androgynous":13, "androgyn":13, "hijra - gender":5, "hijra":5, "bigender":5, "gender non-conforming":5}
...
gender_dict = lower_dict({**gender_dict, **gender_dict_istock, **gender_dict_sex, **gender_dict_sexplural, **gender_dict_both, **gender_dict_TNB})
    ...
    try:
        ...
        try:
            ...
            if pd.isnull(key_no):
                ...
                #
                #
                # TK THIS MIGHT NEED A CLOSER LOOK
                #
                #

                if not isinstance(site_id, int) and not key.startswith('-'):
                    eth_blk_dict = {"black":1, "african":1}
                    eth_dict_blk = {**eth_dict, **eth_blk_dict}

                    if not key in list(eth_dict_blk.keys())+pond5_spacedeth+pond5_spacedkeys:
                        value_list = [site_id,key]
                        print("[unlock_key_plurals_etc pd.isnull] value_list", value_list)
                        write_csv(CSV_NOKEYS_PATH,value_list)
                    else:
                        print("key is in eth_dict_blk, not writing")
                # print(value_list)
                return
            else:
...
def search_keys(keys_list, this_dict, do_write_csv, multi=False):
    ...
    if keys_list:
        ...
        print("[search_keys] no keys_list")
...
def get_gender_age_row(gender_string, age_string, description, keys_list, site_id):
    ...
    if pd.isnull(gender): 
        ...
        if gender_results and len(set(gender_results)) == 1:
            ...
            '''
            TK THIS IS FROM GETTY CODE. I'm not sure if it is better/indifferent
...
def structure_row_pond5(row, ind, keys_list, desc_key):
    #  4435259 items_cache.jsonl
    # 21409581 output.csv
    # 114357130 in ministock

    site_id = SITE_ID #id for the site, not the image
    gender = row[6].replace("_"," ")
    age = row[5].replace("_"," ")
    country = None
    ...
    # handle long URLs
    if len(row[9])>300: contentUrl = "contentUrl was greater than 300 characters search for site_image_id"
    else: contentUrl = row[9]
...
def ingest_csv():
    ...
    def split_pond5_spacekeys(keys_list, pond5_spacedkeys_set):
        ...
        for key in keys_with_spaces:
            if key in pond5_spacedkeys_set:
                ...
                # keep the pond5_spacedeth keys
                if key not in pond5_spacedeth:
    ...
    # replaces binary with code for all binary code keywords. removes it for TNB
    def decompile_binary(keys_list, description):
        print("[decompile_binary]")
        gay_list = ["gay", "queer", "lesbian", "homosexual", "bisexual", "lgbt", "lgbtq", "lgbtqia"]
        otherbinary_list = ["race", "gender", "racism", "discrimination", "discriminate", "sexism", "sexist"]
        key_string = " ".join(keys_list)                                      
        word_soup = description.lower()+key_string

        if "binary" in word_soup:
            # print("binary in word_soup")
            for gaykey in gay_list:
                if gaykey in word_soup:
                    print("gay desc")
                    try:
                    ...
                    return keys_list                
            for key in keys_list:
                print("searching keys for", key)
                if "binary" in key:
                    is_TNB = get_TNB(description.lower(), keys_list)
                    print("is_TNB", is_TNB, key, description, keys_list)
                    if is_TNB == 7:
    ...
    if SITE_ID == 7:
        ...
        # keeping black and african in the eth_dict
        eth_keys_dict = eth_dict
        ...
        for row in reader_obj:
            ...
            try:
                ...
                if SITE_ID == 7:
                    ...
                    print("description", row[desc_key])
                    keys_list = split_pond5_keys(keys_list, "\n")
                    keys_list = split_pond5_spacekeys(keys_list, pond5_spacedkeys_set)            
            
                # clarifies binary code vs non binary gender
                keys_list = decompile_binary(keys_list, row[desc_key])
            ...
            if SITE_ID == 7:
                image_row = structure_row_pond5(row, ind, keys_list, desc_key)
            ...
            if not pd.isnull(row[column_eth]) and len(row[column_eth])>0:
                ...
                if 6 in eth_no_list or not eth_no_list:
                    #
                    # TK NEED TO TEST THIS MERG DICT AND INTEGRATE THE GETTY CODE FOR DETECTING AND INSERTING MULTI ETH
                    #
                    # adds in a keyword search for multi ethnic/mixed 
                    if 6 in eth_no_list: print("6 in eth_no_list")
                    eth_blk_dict = {"black":1, "african":1}
                    merge_eth_dict = {**eth_dict, **eth_blk_dict}
                    # print("merge_eth_dict", merge_eth_dict)
                    eth_no_list2 = get_key_no_dictonly(None, keys_list, merge_eth_dict, True)
                    if not eth_no_list2:
                        print("no eth_no_list, searching eth_dict_secondary")
                        eth_no_list2 = get_key_no_dictonly(None, keys_list, eth_dict_secondary, True)
                    if not eth_no_list2:
                        print("still no eth_no_list, searching description")
                        # eth_no_list2 = get_key_no_dictonly(None, keys_list, eth_dict_secondary, True)
                        desc_tokens = image_row['description'].split(" ")
                        eth_no_list2 = get_key_no_dictonly(None, desc_tokens, merge_eth_dict, True)
                        print("eth_no_list2", eth_no_list2)
                        # key_nos_list = set(key_nos_list + desc_key_nos_list)
                    print(f"eth_dict_secondary found for {eth_no_list2}")
                    eth_no_list = list(set(eth_no_list + eth_no_list2))
                    print(f"merged eth_no_list {eth_no_list}")
                else:
                    print("have etn, not mixed/multi", eth_no_list)
                ...
                if not eth_no_list:
                    ...
                    merge_eth_dict = {**eth_dict, **eth_blk_dict}
                    desc_tokens = image_row['description'].split(" ")
                    eth_no_list = get_key_no_dictonly(None, desc_tokens, merge_eth_dict, True)
                    print("eth_no_list from description", eth_no_list)
                print("Unlocked this many:",eth_no_list)
                ...
                with engine.connect() as conn:
                    ...
                    if row is None:
                        ...
                        if eth_no_list and result.lastrowid:
                            print("about to insert to DB this eth_no_list", eth_no_list)
