...
MULTIPLIER_LIST = [
    ...
    [1.8,4.5,3.8,4.5], # 13 extra extra wide 9x16 landscape (flag pose)
    [1.3,1.3,2.4,2.4], # 14 SQ shift LEFT
    [3,4.5,6,4.5], # 15 extra big SQ (SQ flag pose)
