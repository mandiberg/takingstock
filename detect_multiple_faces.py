...
def process_image_find_body_subroutine(image_id, image, bbox):
    ...
    if existing_norm:
        ...
        if is_body:
            ...
            n_landmarks = None
    return is_body, n_landmarks, body_landmarks, face_height, nose_pixel_pos
                    ...
                    for img in batch_img_list:
                        ...
                        if site_image_id in results_dict:
                            ...
                            if result.encoding_id:
                                print(" ^o^ this one has no face? ", result.encoding_id)
                                ...
                                #             break
                                if result.mongo_face_landmarks is None:
