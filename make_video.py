...
def merge_inpaint2(inpaint_image,img,extended_img,extension_pixels,selfie_bbox,blur_radius=BLUR_RADIUS):
    ...
    # # start with white shape
    # mask_top = mask_bottom = mask_left = mask_right = np.ones(np.shape(inpaint_image)) * 255

    # if top:
    #     # if extension, add black pixels, then blur
    #     mask_top[:top,:] = [0,0,0]
