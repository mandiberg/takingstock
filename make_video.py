...
CSV_RUN_FOLDER = "SegmentHelper_TheOffice/_hsv_bg_2tier_trim2/" # this is the folder that will be made inside CSV_MAIN_FOLDER, and is also the name of the SegmentHelper that will be used for the SQL query. It is also added to the manifest file for reference.
...
def _mode1_find_parts(parts: list) -> tuple:
    ...
    for part in parts:
        if part.startswith("ct"):
            ...
            object_hsv_no = part.split("sb", 1)[1]
